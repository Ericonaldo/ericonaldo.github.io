...
* I am currently a Postdoc at [RPL Lab](https://rpl.cs.utexas.edu/), [UT Austin](https://www.utexas.edu/), working with Prof. [Yuke Zhu](https://yukezhu.me/). Before that I worked as a research staff at ByteDance Seed-Robotics (2024-2025). I obtained my Ph.D. degree at 2024 in [Apex Lab.](http://apex.sjtu.edu.cn) at [Shanghai Jiao Tong University](http://en.sjtu.edu.cn/), supervised by [Prof. Weinan Zhang](http://wnzhang.net/) and [Prof. Yong Yu](http://apex.sjtu.edu.cn/members/yyu). I used to be the group leader of [ApexRL](https://github.com/apexrl), the RL research group of Apex Lab. I was also a member of [Wu Wen Jun Honorary Doctoral Plan (吴文俊荣誉博士班)](https://xsb.seiee.sjtu.edu.cn/xsb/info/33498.htm), advised by [Prof. Cewu Lu](https://www.mvig.org/). During my Ph.D. (2023-2024), I visited Prof. [Xiaolong Wang](https://xiaolonw.github.io/)'s Lab at UC San Diego, and did robotics learning research. I won [ByteDance Scholars Program (字节跳动奖学金)](https://ur.bytedance.com/scholarship) (10 candidates worldwide each year) in 2022. I received my Bachelor’s Degree at [Southwest Jiao Tong University](http://www.swjtu.edu.cn/) in 2019.  [[My Curriculum Vitae]](/files/minghuanliu_cv.pdf) (updated in Sept. 2025)
...
* I have been working on one of the most complicated decision-making problems, **robots**, aiming at taking intelligent robots closer to real life, e.g., expanding the skills of robots, and helping robots make smart decisions. Recently, I've been thinking about the right way to build the real general robot policies, specifically, the way to **align the action (embodiment's 3D information) to the world (external 3D information)**, instead of replaying trajectories from generalized observation representations (current policies work like this).
...
# Recent News
* Jan. 31, 2026. Cross-humanoid locomotion [H-zero]([http://hugwbc.github.io/](https://arxiv.org/abs/2512.00971)) and real2sim2real [Re3Sim](https://xshenhan.github.io/Re3Sim/) accepted by ICRA 2026.
...
<b>Nature Machine Intelligence</b>.  [<a href="https://arxiv.org/abs/2412.14058">paper</a>] [<a href="https://robovlms.github.io/">project</a>] [<a href="https://github.com/Robot-VLAs/RoboVLMs">code</a>]
<br>
...
# Services
* Conference Reviewer: NeurIPS'21'22'23, ICML'21'22'23, ICLR'23'24, CVPR'24'25, IROS'24, RAL'25, RSS'25

# Misc
* I love playing / watching football (soccer), forward, a fan of [Shandong Luneng Taishan](http://www.lnts.com.cn/), a beginner of football analytics with AI. 
